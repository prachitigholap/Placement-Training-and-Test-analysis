...
$res=mysqli_query($link, "select * from add_questions where qid=$id");
    ...
    <body style="background-color: rgb(207, 205, 205);">
        ...
        <div class="card container col-lg-4 col-md-6 col-sm-12 mt-1 justify-content-center" style="border: 1px solid black; ">
            <div class="card-header" style=" padding:1%">
                <strong style="font-size: 19px;">Edit Question </strong>
                <hr>
        ...
        <?php
            ...
            if(isset($_POST["Submit"]))
            {
                    ...
                    mysqli_query($link, "update add_questions set question='$_POST[question]', opt1='$_POST[opt1]', opt2='$_POST[opt2]', opt3='$_POST[opt3]', opt4='$_POST[opt4]', result='$_POST[result]' where qid=$id");
                    // if($count==0)
                    // {
