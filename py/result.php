...
$totalmark=$row['testmarks'];
   ...
   $m=mysqli_query($con,"select * from ( SELECT DENSE_RANK() OVER (PARTITION BY '$id' ORDER BY `score` DESC) as RN FROM history where history.email_id = '$email' ) a");
       ...
       *{
       ...
       <h2>Well Done!!</h2>
         ...
         <br>
           ...
           <br>
           <h3><b>Test Average Marks: '.$b['b'].'</b></h3>
           <br>
