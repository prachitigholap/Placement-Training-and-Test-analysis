...
?>
    ...
    <body>
       ...
       while($row = mysqli_fetch_array($result)) 
       {
        ...
        <h6 class="f-w-600">Name: <h10 style="font-weight: 400;">' .$name.'</h10> </h6> &nbsp;
        <h6 class="f-w-600">Student Id: <h10 style="font-weight: 400;">' .$id.'</h10> </h6><i class=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
    </div>
</div>
<div class="col-sm-8">
